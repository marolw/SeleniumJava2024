...
public class BasePage {
    ...
    */
    ...
    // Encuentra y devuelve un WebElement en la página utilizando un locator XPath, esperando a que esté visible
    ...
    //Método para seleccionar un elemento de un dropdown por su texto
 public void selectFromDropdownByValue(String locator, String value){
        Select dropdown = new Select(Find(locator));
 
        dropdown.selectByValue(value);
    }
    //  Método para seleccionar un elemento de un dropdown por su índice
